        ...
        <div className="mt-auto flex flex-col gap-1.5">
          ...
          <div className="flex gap-1.5">
            <button
              ...
              className="btn-primary flex h-9 w-10 shrink-0 items-center justify-center rounded-lg border-2 border-ink shadow-[2px_2px_0_#000] transition-transform hover:-translate-y-0.5 disabled:cursor-not-allowed disabled:opacity-50 sm:h-10 sm:w-11 sm:rounded-xl"
            >
